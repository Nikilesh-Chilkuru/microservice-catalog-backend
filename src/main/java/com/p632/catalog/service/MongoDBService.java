...
/**
 * This service class saves {@link com.p632.catalog.service.MS} objects to
 * MongoDB database.
 * 
 * @author Naveen Jetty
 */
...
final class MongoDBService implements MSService {
	...
	public MSDTO create(MSDTO ms) {
		...
		MS persisted = MS.builder().title(ms.getTitle()).description(ms.getDescription()).url(ms.getUrl()).build();
